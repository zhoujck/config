   ...
   /* class_name:'历史&人文&宇宙&自然&动物&科技&美食&探险',
    class_url:'10033&10065&10068&10072&10071&10066&10045&10067',*/
        ...
        if (tid == "首页") {
            ...
            url = "https://api.bilibili.com/pgc/season/index/result?order=2&pagesize=20&style_id=10065&type=1&season_type=3&st=3";
        }
         else if (tid == "宇宙") {
            url = "https://api.bilibili.com/pgc/season/index/result?order=2&pagesize=20&style_id=10068&type=1&season_type=3&st=3";
        }
         else if (tid == "自然") {
            url = "https://api.bilibili.com/pgc/season/index/result?order=2&pagesize=20&style_id=10072&type=1&season_type=3&st=3";
        }
         else if (tid == "动物") {
            url = "https://api.bilibili.com/pgc/season/index/result?order=2&pagesize=20&style_id=10071&type=1&season_type=3&st=3";
        }
         else if (tid == "科技") {
            url = "https://api.bilibili.com/pgc/season/index/result?order=2&pagesize=20&style_id=10066&type=1&season_type=3&st=3";
        }
         else if (tid == "探险") {
            url = "https://api.bilibili.com/pgc/season/index/result?order=2&pagesize=20&style_id=10067&type=1&season_type=3&st=3";
        }
